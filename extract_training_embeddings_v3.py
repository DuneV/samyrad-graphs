#!/usr/bin/env python3
"""
extract_training_embeddings_v3.py
====================================
...
Uso: idéntico a v2.
    python3 extract_training_embeddings_v3.py \
...
def main():
    ...
    parser.add_argument("--max-frames-to-embed", type=int, default=4,
                        help="Máximo de frames de la ventana a los que se "
                             "les calcula embedding (para no disparar el "
                             "costo de CLIP: con 8 frames de ventana y esto "
                             "en 4, se muestrean 4 equiespaciados en vez de "
                             "los 8, y se promedian)")
    ...
    print(f"\nGuardado {len(y)} muestras ({X.shape[1]}-dim) en {args.output}")
